...
# [JB] Added the following 8 lines to generate a random password for when a staff member needs to reset a patron password
...
$template->param(
  ...
  # [JB] Added temporary flag
  temporary => ($categorycode eq 'TP')
  );
